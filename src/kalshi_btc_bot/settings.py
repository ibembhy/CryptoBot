...
def load_settings(config_path: str | Path | None = None) -> Settings:
    ...
    effective_path = Path(config_path or os.getenv("KALSHI_BTC_CONFIG_PATH", "")).expanduser() if (config_path or os.getenv("KALSHI_BTC_CONFIG_PATH")) else None
    if effective_path:
    ...
    for section_name, section in config.items():
        ...
        for key, current_value in list(section.items()):
            env_name = f"KALSHI_BTC_{section_name}_{key}".upper()
